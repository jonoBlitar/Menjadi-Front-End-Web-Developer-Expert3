...
const restoDetil = (resto) => `
  ...
  CONFIG.BASE_IMAGE_URL + resto.pictureId
    ...
    <ul class="detail-info">
      <li>
        <i title="restaurant" class="fa fa-window-restore"></i>
        <p class="detail-name-address-rating">${resto.name}</p>
        </li>

      <li>
        <i title="address" class="fa fa-address-card"></i>
